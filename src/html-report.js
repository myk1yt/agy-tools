...
function renderDashboardHtml(payload, opts = {}) {
  ...
  const clientScript = [
    ...
    "    if (!w) return;",
    "    var isStaleGq = gq && (gq.isStale || (gq.lastError && gq.lastError.kind === 'auth_failure'));",
    "    var canUseLiveGq = gq && gq.remainPercent !== null && gq.remainPercent !== undefined && (!isStaleGq || !r);",
